...
import { FaMap, FaBed, FaBookmark, FaBrain, FaCheckCircle, FaChevronDown, FaChevronRight, FaExclamationCircle, FaMapMarkerAlt, FaRegBookmark, FaCalendarAlt, FaTimesCircle } from "react-icons/fa";
      ...
      <div className="sm:flex">
        ...
        <div className="flex-1 p-5">
          ...
          {property.distance_evidence && (
            <p className="mt-2 text-xs font-semibold text-[var(--forest)] bg-green-50 w-fit px-2 py-1 rounded-md">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            {(property.latitude && property.longitude) && (
              <button 
                ...
                className="cursor-pointer flex items-center rounded-full border border-[var(--forest)] text-[var(--forest)] px-4 py-2 text-xs font-semibold transition hover:bg-green-50">
      ...
      <div className="sm:flex">
        ...
        <div className="flex-1 p-5">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <button onClick={onReject} className="cursor-pointer rounded-full border border-black/10 px-3 py-2 text-xs font-semibold text-[var(--muted)] transition hover:bg-red-50 hover:text-red-600" title="Loại căn này">
              <FaTimesCircle className="text-lg" />
            </button>
          </div>

          {showMap && property.latitude && property.longitude && (
            <div className="mt-4 overflow-hidden rounded-xl border border-black/10 bg-stone-100">
              <iframe
                width="100%"
                height="220"
                style={{ border: 0 }}
